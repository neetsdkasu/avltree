...
func TestInsertOneEntry(t *testing.T) {
	...
	g := func(k, v int) Tree {
		root := &SimpleNode{nil, nil, 1, IntKey(k), v}
		tree := &SimpleTree{root, false}
		return tree
	}
...
func TestInsertTwoEntries(t *testing.T) {
	...
	g := func(k1, v1, k2, v2 int) Tree {
		...
		root := &SimpleNode{nil, nil, 2, IntKey(k1), v1}
		child := &SimpleNode{nil, nil, 1, IntKey(k2), v2}
		if k2 < k1 {
...
func TestReplaceDuplicateKey(t *testing.T) {
	...
	g := func(k1, v1, k2, v2, v3, v4 int) Tree {
		...
		root := &SimpleNode{nil, nil, 2, IntKey(k1), v3}
		child := &SimpleNode{nil, nil, 1, IntKey(k2), v4}
		if k2 < k1 {
			root.LeftChildNode = child
		} else {
			root.RightChildNode = child
...
func TestAllowDuplicateKey(t *testing.T) {
	...
	g := func(k1, v1, k2, v2, v3, v4 int) Tree {
		...
		var root *SimpleNode
		if k2 < k1 {
			root = &SimpleNode{nil, nil, 3, IntKey(k1), v1}
			lChild := &SimpleNode{nil, nil, 2, IntKey(k2), v2}
			rChild := &SimpleNode{nil, nil, 1, IntKey(k1), v3}
			lrChild := &SimpleNode{nil, nil, 1, IntKey(k2), v4}
			lChild.RightChildNode = lrChild
			root.LeftChildNode = lChild
			root.RightChildNode = rChild
		} else {
			root = &SimpleNode{nil, nil, 3, IntKey(k1), v3}
			lChild := &SimpleNode{nil, nil, 1, IntKey(k1), v1}
			rChild := &SimpleNode{nil, nil, 2, IntKey(k2), v2}
			rrChild := &SimpleNode{nil, nil, 1, IntKey(k2), v4}
			rChild.RightChildNode = rrChild
			root.LeftChildNode = lChild
			root.RightChildNode = rChild
		}
		tree := &SimpleTree{root, true}
		return tree
	}
